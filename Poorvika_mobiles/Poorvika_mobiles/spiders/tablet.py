...
class PoorvikaSpider(scrapy.Spider):
    ...
    def parse(self, response, **kwargs):
        ...
        for i in range(1000):
                ...
                if ('tab' in page[k+10:k2-1].split('-') and page[k+10:k2-1].split('-')[-1] in ['ram','8gb','4gb','2gb','12gb','16gb','64gb','128gb','256gb','512gb']) or (page[k+10:k2-1].split('-')[0].endswith('2hn') and page[k+10:k2-1].split('-')[-1]=='a') or ('ipad' in page[k+10:k2-1].split('-') and page[k+10:k2-1].split('-')[-1]=='generation'):
    ...
    def parse_elec(self, response):
                ...
                if 'Adapter' not in product_name.split():
                                yield items
